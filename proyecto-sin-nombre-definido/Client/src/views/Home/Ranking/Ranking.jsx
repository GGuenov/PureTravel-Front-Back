...
const Ranking = () => {
  ...
  const nameCut = (name) => {
    ...
    return (
      <p style={{ fontWeight: "bold", fontSize: "15px", padding: "10px" }}>
        {name}
      </p>
    );
  };
  ...
  return (
    <div>
      ...
      <div className="row">
          ...
          <article className={style.card2}>
            ...
            <div className={style.cardContent}>
              <span className={style.cardTitle}>
                ¡Bienvenidos a la nueva era de las experiencias de viaje!
              </span>
              <span className={style.cardSubtitle}>
                En Airbnb, estamos emocionados de presentar las últimas
                novedades que harán que tus aventuras sean aún más emocionantes.
              </span>
              <p className={style.cardDescription}>
                Ahora puedes explorar alojamientos únicos en lugares remotos,
                descubrir experiencias locales auténticas y conectar con
                anfitriones excepcionales de todo el mundo.
              </p>
              <p className={style.cardDescription}>
                Además, hemos mejorado nuestra plataforma para brindarte una
                reserva más fácil y segura, con opciones de pago flexibles y una
                atención al cliente excepcional.
              </p>
              <p className={style.cardDescription}>
                Ya sea que estés planeando unas vacaciones familiares, una
                escapada romántica o una aventura solitaria, Airbnb está aquí
                para hacer realidad tus sueños de viaje.
              </p>
              <p className={style.cardDescription}>
                Únete a millones de viajeros que confían en nosotros para crear
                recuerdos inolvidables. ¡Descubre las últimas novedades y
                reserva tu próximo viaje con Airbnb hoy mismo!
              </p>
        ...
        <div className="col-6" style={{ width: "50%", height: "100%" }}>
          <div className="row">
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  {users.length > 0
                    ...
                    : null}
                  {users.length > 0
                    ? users.slice(3, 5).map((ele, index) => (
                        <tr key={ele.id}>
                          <th scope="row" style={{ paddingLeft: "15px" }}>
                            {index + 4}
                          </th>
                          <td>
                            <img
